# -*- coding: utf-8 -*-
"""
Created on Thu Jul 20 10:26:29 2017
...
def content_loss_func(sess, model):
    ...
    return _content_loss(sess.run(model['conv4_2']), model['conv4_2']) # Only use layer conv4_2
...
ITERATIONS = 1  # The art.py uses 5000 iterations, and yields far more appealing results. If you can wait, use 5000.
